...
@objc public enum ImageActionStyle : Int {
    case Default
    case Cancel
}
...
@objc public class ImageAction : NSObject{
    ...
    public convenience init(title: String, secondaryTitle: String? = nil, style: ImageActionStyle = .Default, handler: Handler? = nil, secondaryHandler: SecondaryHandler? = nil) {
        self.init(primaryTitle: title, secondaryTitle: secondaryTitle.map { string in { _ in string }}, style: style, handler: handler, secondaryHandler: secondaryHandler)
    }
